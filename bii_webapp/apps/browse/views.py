...
def assay(request, invID=None, studyID=None, measurement=None, technology=None):
    ...
    if loaded == None:
        try:
            ...
            cache.set((str)(studyID) + "_" + (str)(measurement) + "_" + (str)(technology), loaded, -1)
