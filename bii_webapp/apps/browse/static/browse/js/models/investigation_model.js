...
$(document).ready(function () {
    ...
    InvestigationModel = function (investigation) {
        ...
        if (investigation == undefined) {
            ...
            var invData=investigation;
            invData['i_pubs_model']=new PublicationModel(investigation.i_publications);
            invData['i_contacts_model']=new ContactModel(investigation.i_contacts);
            invData['i_studies_model']=new StudyModel(investigation.i_studies);
            delete invData['i_publications'];
            delete invData['i_contacts'];
            delete invData['i_studies'];
        }

        var self = this;
        self.investigation = ko.observable(invData);
